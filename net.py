...
model = Sequential(
    ...
    # Linear(1000, 500),
    # ReLU(),
    # Dropout(0.1), #dropout refers to ignoring units during the training phase of certain set of neurons which is chosen at random. It is done to increase independency of model
    # Linear(500, 131))
    Flatten(),
